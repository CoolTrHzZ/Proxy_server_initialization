...
```bash
curl -fsSL https://raw.githubusercontent.com/CoolTrHzZ/Proxy_server_initialization/main/bootstrap.sh | bash
```

Install fixed version:

```bash
curl -fsSL https://raw.githubusercontent.com/CoolTrHzZ/Proxy_server_initialization/main/bootstrap.sh | bash -s -- v1.3.0
```

The bootstrap installer downloads the official GitHub Release package, extracts it and starts the normal installation workflow.
...
GitHub Actions will automatically build the archive and create the Release package.
